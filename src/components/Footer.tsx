...
const Footer: React.FC = () => {
  const whatsappNumber = '+573234923424';
  const whatsappMessage = 'Hola! Me gustaría obtener más información sobre sus productos.';
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(whatsappMessage)}`;
  const instagramUrl = 'https://www.instagram.com/alforjacafe/';

  return (
    <footer className="bg-amber-900 text-white p-6 mt-8">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 gap-6 text-center md:text-left">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p className="text-amber-100">WhatsApp: +57 323 4923424</p>
              <p className="text-amber-100">Horario: Lun - Vie 8:00 - 18:00</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white p-2 rounded-full transition-colors duration-200"
        ...
        <div className="border-t border-amber-800 mt-6 pt-4 text-center">
          <p className="text-sm text-amber-100">
            &copy; 2025 Alforja Café. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
